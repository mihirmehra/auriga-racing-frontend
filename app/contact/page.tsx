            ...
            <CardContent className="p-12">
              ...
              <div className="space-y-4">
                ...
                <div className="text-sm text-gray-500">
                  <p>Reference ID: #MSG-{Date.now().toString().slice(-6)}</p>
                </div>
              </div>
            </CardContent>
          </Card>
      ...
      <section className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 max-w-2xl mx-auto">
            We are here to help! Get in touch with our team for any questions, support, or feedback.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 text-sm">
                  ...
                  or use the tracking number sent to your email.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 text-sm">
                  Yes, we ship to over 25 countries worldwide. Shipping costs and delivery times 
                  vary by destination. Check our shipping page for details.
                </p>
              </CardContent>
            </Card>
          </div>
